          ...
          <v-row>
            <v-col cols="12">
              <v-form ref="form" calsss="mx-2" lazy-validation>
                ...
                <v-row>
                  <v-col cols="4">
                    <v-text-field v-model="data.body" :rules="[v => !!v || 'Body is required']" label="Body" required></v-text-field>
                  </v-col>
                </v-row>
                <v-row>
                  <v-col cols="4">
                    <v-text-field v-model="data.email" :rules="[
                ...
                <v-row>
                  <v-col cols="4">
                    <v-file-input v-model="data.files" label="File"></v-file-input>
                  </v-col>
                </v-row>
